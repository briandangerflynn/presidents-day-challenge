...
class TeamMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create team_member" do
    assert_difference('TeamMember.count') do
      post team_members_url, params: { team_member: { score: @team_member.score, team_id: @team_member.team_id, user_id: @team_member.user_id } }, as: :json
    end
  ...
  test "should update team_member" do
    patch team_member_url(@team_member), params: { team_member: { score: @team_member.score, team_id: @team_member.team_id, user_id: @team_member.user_id } }, as: :json
    assert_response 200
  end
